...
const Color colorPrimary = Color(0xFF587AFF);
const Color colorPrimaryLight = Color(0xFFC3D1FF);
const Color colorPrimaryLighter = Color(0xFFF1F3FF);
...
const Color colorGrayDark = Color(0xFF5E5E5E);
